        ...
        this.on("object:modified", (e) => {
            if (e.target.isType("rect")) {
                ...
                if (target !== null && target.isContainer) {
                    ...
                    activeObject.setPos(
                        target.top + 10,
                        target.left + 10 + (activeObject.width * target.childObjects.length));
...
export class Rect extends fabric.Rect {
    constructor(data) {
        super({
            ...
            childObjects: (data.childObjects && data.childObjects.length > 0) ? data.childObjects : [], // ? Maybe its more correct to use a fabric.Collection
            parent: data.parent || null,
            emType: data.emType,
            label: data.label || null,
            isContainer: HTML_ELEMENTS[data.emType].isContainer,
            ...
            fill: HTML_ELEMENTS[data.emType].color,
            top: data.top || 0,
            left: data.left || 0,
